...
public class Artemis {
    ...
    public static final Group administratorGroup = new AdministratorGroup(new BiometricAuthentication());
    public static final Group editorGroup = new EditorGroup(new OAuthAuthentication());
    public static final Group tutorsGroup = new TutorsGroup(new TwoFactorAuthentication());
